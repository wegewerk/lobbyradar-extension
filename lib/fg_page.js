...
var tweet_text = '#Lobbyradar-Browserweiterung hat diese Verbindungen von %name gefunden. %link';
        ...
        functionBefore:function(origin, continueTooltip) {
            ...
            generateTooltip(id, function(content,person){
                ...
                new Shariff(function() {
                    ...
                    title: tweet_text.replace('%name',person.names[0]).replace('%link',detail_url_extern+id),
...
function generateTooltip(id, callback) {
    ...
    BabelExt.bgMessage({requestType:'detail_for_id',id:id},function(parent_person){
            ...
            tt_content += '</a>'
            tt_content += '</div><br/>';
            tt_content += '<a href="'+detail_url_extern+id+'" target="_blank" class="name_info">'
            ...
            $.each(parent_person.connections,function(i,conn_id) {
                BabelExt.bgMessage({requestType:'detail_for_id',id:conn_id},function(person){
                    ...
                    row_content += detail_url_extern+conn_id + '">';
